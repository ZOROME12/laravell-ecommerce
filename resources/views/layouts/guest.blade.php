                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" required autofocus
                                   ...
                                   placeholder="Enter your email" autocomplete="off"> </div>
                        @error('email')
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password" required
                                   class="w-full border rounded-lg pl-10 pr-10 py-2 text-sm focus:ring-2 focus:ring-[#ED4A69] focus:border-[#ED4A69]" placeholder="Enter your password" autocomplete="off"> <button type="button" class="absolute inset-y-0 right-0 flex items-center pr-3 z-10 password-toggle" data-target="password">
                                <i class="fa-solid fa-eye text-gray-500 hover:text-[#B2183A] cursor-pointer"></i>
                            </button>
                        </div>
                        @error('password')
                            <span class="text-sm text-red-500 mt-1 block">{{ $message }}</span>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5 relative z-10" id="registerForm">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password" required
                                   class="w-full border rounded-lg pl-10 pr-10 py-2 text-sm focus:ring-2 focus:ring-[#ED4A69] focus:border-[#ED4A69]" placeholder="Enter your password"
                                   pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[\W_]).{8,}$"
                                   title="Must be 8+ characters, with at least 1 uppercase, 1 lowercase, 1 number, and 1 symbol.">
                            <button type="button" class="absolute inset-y-0 right-0 flex items-center pr-3 z-10 password-toggle" data-target="password">
                                <i class="fa-solid fa-eye text-gray-500 hover:text-[#B2183A] cursor-pointer"></i>
                            </button>
                        </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password_confirmation" type="password" name="password_confirmation" required
                                   class="w-full border rounded-lg pl-10 pr-10 py-2 text-sm focus:ring-2 focus:ring-[#ED4A69] focus:border-[#ED4A69]" placeholder="Re-enter your password">
                            <button type="button" class="absolute inset-y-0 right-0 flex items-center pr-3 z-10 password-toggle" data-target="password_confirmation">
                                <i class="fa-solid fa-eye text-gray-500 hover:text-[#B2183A] cursor-pointer"></i>
                            </button>
                        </div>
